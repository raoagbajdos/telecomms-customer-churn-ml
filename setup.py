#!/usr/bin/env python3
"""
Setup and installation script for the telecoms customer churn ML project.
"""
...
def setup_project():
    """Set up the project."""
    print("🚀 Setting up Telecoms Customer Churn ML Project")
    print("=" * 60)
    ...
    print("\n🎉 Setup completed!")
    print("=" * 60)
    print("✅ Your telecoms customer churn ML project is ready!")
    print("\n📋 Next steps:")
    ...
    print("   4. Or use the CLI: churn-predict --help")
    print("\n📚 Documentation:")
